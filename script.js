    ...
    questions: [
        {
            ...
            answers: [
                { text: "🛡️ Protect others, even at personal risk", points: { paladin: 3, cleric: 2, fighter: 1 } },
                { text: "🔍 Analyze the situation before acting", points: { wizard: 3, rogue: 2, cleric: 1 } },
                { text: "⚔️ Charge in headfirst", points: { fighter: 3, barbarian: 2, paladin: 1 } },
                { text: "🌿 Find a clever, unconventional solution", points: { rogue: 3, druid: 2, wizard: 1 } }
            ]
        },
        {
            question: "What do people usually ask for your help with?",
            answers: [
                { text: "🧘‍♀️ Emotional support or advice", points: { cleric: 3, paladin: 2, bard: 1 } },
                { text: "🧠 Solving puzzles or riddles", points: { wizard: 3, rogue: 2, bard: 1 } },
                { text: "💪 Physical tasks or combat", points: { fighter: 3, barbarian: 2, paladin: 1 } },
                { text: "🧙‍♂️ Creative or magical ideas", points: { bard: 3, warlock: 2, druid: 1 } }
            ]
        },
        {
            question: "How do you react when someone judges you unfairly?",
            answers: [
                { text: "😌 Let it go—you know who you are", points: { druid: 3, cleric: 2, paladin: 1 } },
                { text: "🤔 Try to understand their perspective", points: { cleric: 3, wizard: 2, bard: 1 } },
                { text: "⚡ Confront them directly", points: { paladin: 3, fighter: 2, barbarian: 1 } },
                { text: "🌑 Plot a subtle revenge", points: { rogue: 3, warlock: 2, wizard: 1 } }
            ]
        },
        {
            question: "Your ideal weekend looks like...",
            answers: [
                { text: "📚 Reading a book by the fire", points: { wizard: 3, cleric: 2, druid: 1 } },
                { text: "🧩 Solving a complex board game", points: { rogue: 3, wizard: 2, bard: 1 } },
                { text: "🛡️ Training or practicing a skill", points: { fighter: 3, paladin: 2, barbarian: 1 } },
                { text: "🌌 Exploring the unknown", points: { druid: 3, rogue: 2, warlock: 1 } }
            ]
        },
        {
            question: "What's your relationship with authority?",
            answers: [
                { text: "🙋‍♀️ Respect it, but question it", points: { paladin: 3, rogue: 2, cleric: 1 } },
                { text: "🧾 Follow it strictly", points: { fighter: 3, cleric: 2, paladin: 1 } },
                { text: "🤷‍♂️ Ignore it unless forced", points: { rogue: 3, barbarian: 2, druid: 1 } },
                { text: "🎭 Use it to your advantage", points: { bard: 3, warlock: 2, rogue: 1 } }
            ]
        },
        {
            question: "Which element resonates most with you?",
            answers: [
                { text: "💧 Water – adaptable and deep", points: { druid: 3, cleric: 2, rogue: 1 } },
                { text: "🔥 Fire – passionate and intense", points: { barbarian: 3, sorcerer: 2, paladin: 1 } },
                { text: "🌍 Earth – grounded and strong", points: { druid: 3, fighter: 2, cleric: 1 } },
                { text: "🌪️ Air – free and clever", points: { wizard: 3, sorcerer: 2, bard: 1 } }
            ]
        },
        {
            question: "What's your biggest flaw?",
            answers: [
                { text: "🫂 Overprotectiveness", points: { paladin: 3, cleric: 2, druid: 1 } },
                { text: "🧊 Cold logic", points: { wizard: 3, rogue: 2, fighter: 1 } },
                { text: "🤯 Impulsiveness", points: { barbarian: 3, sorcerer: 2, bard: 1 } },
                { text: "🌫️ Indecisiveness", points: { druid: 3, wizard: 2, rogue: 1 } }
            ]
        },
        {
            question: "In a group, you're usually the...",
            answers: [
                { text: "💬 Mediator", points: { cleric: 3, bard: 2, paladin: 1 } },
                { text: "🧠 Strategist", points: { wizard: 3, rogue: 2, fighter: 1 } },
                { text: "⚔️ Leader", points: { paladin: 3, fighter: 2, barbarian: 1 } },
                { text: "🎭 Wildcard", points: { bard: 3, sorcerer: 2, rogue: 1 } }
            ]
        },
        {
            question: "What do you value most?",
            answers: [
                { text: "🤝 Loyalty", points: { paladin: 3, fighter: 2, cleric: 1 } },
                { text: "🧠 Knowledge", points: { wizard: 3, cleric: 2, rogue: 1 } },
                { text: "💪 Power", points: { barbarian: 3, fighter: 2, sorcerer: 1 } },
                { text: "🌟 Freedom", points: { rogue: 3, druid: 2, bard: 1 } }
            ]
        },
        {
            question: "If you could have any magical ability, it would be...",
            answers: [
                { text: "🛡️ Healing or protection", points: { cleric: 3, paladin: 2, druid: 1 } },
                { text: "🔮 Divination or mind magic", points: { wizard: 3, warlock: 2, bard: 1 } },
                { text: "⚡ Destruction or combat magic", points: { sorcerer: 3, wizard: 2, barbarian: 1 } },
                { text: "🌿 Nature or illusion magic", points: { druid: 3, bard: 2, warlock: 1 } }
            ]
        }
    ],
    results: {
